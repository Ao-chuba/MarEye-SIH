...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 3:
        ...
        input_path = "D:\MAREYE-frontend(no modules, .next,venv)\Oceanova---SIH\temp\input\mines1.jpg"
        output_path = "D:\MAREYE-frontend(no modules, .next,venv)\Oceanova---SIH\temp\output\enhanced_mines1.jpg"
